...
import kotlinx.android.synthetic.main.activity_detail_cards.*

class Detail_cards : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        desc = bundle!!.getString("" + "Card_type")!!
        init()
        clicks()
    }
    ...
    private fun clicks() {
        ...
        txt_done_card_detail.setOnClickListener {
            val intent  = Intent(this, PayoutsListActivity::class.java)
            startActivity(intent)
        }
    }
    ...
    private fun init() {
        ...
        txt_card_type_details.text=card_name
        txt_card_name_details.text=desc
